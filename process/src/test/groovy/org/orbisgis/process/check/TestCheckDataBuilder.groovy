...
import org.orbisgis.process.impl.check.CheckDataBuilder
import org.orbisgis.process.impl.inoutput.Input
import org.orbisgis.process.impl.inoutput.Output

/**
 * Test class dedicated to {@link org.orbisgis.process.impl.check.CheckClosureBuilder} class.
 *
...
class TestCheckDataBuilder {
    ...
    /**
     * Test the {@link org.orbisgis.process.impl.check.CheckDataBuilder#with(IInOutPut...)} method.
     */
    @Test
    void withTest() {
